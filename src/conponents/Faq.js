  ...
  return (
    <div>
              ...
              <div style={{ width: "80%", marginLeft: "10%" }}>
                ...
                <Accordion defaultActiveKey={["0"]} alwaysOpen>
                  <Accordion.Item eventKey="0">
                    ...
                    >
                      我們與便利商店或量販店進行合作，合作機構從商家所販賣之常態性商品中提出物資需求，捐贈者於線上認購物資，進行線上付款後，合作機構便能向鄰近商家兌換物資，達成其物資需求。
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
                <br />
                ...
                <Accordion alwaysOpen>
                  ...
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body
                      style={{ letterSpacing: "1.5px", lineHeight: "28px" }}
                    >
                      為符合物資認購合法性與正當性，以及讓捐贈者安心捐贈，我們要求合作機構須為政府立案之合法機構，而為進行驗證才會請您提供相關資料，感謝您的配合。
                    </Accordion.Body>
                  </Accordion.Item>
                ...
                <Accordion alwaysOpen>
                  ...
                  <Accordion.Item eventKey="3">
                    ...
                    >
                      ...
                      ，進入「捐贈進度追縱」頁面，目前物資捐贈的進度便會顯示於捐贈的每項物資右方。
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
                <br />
      ...
      {user.email === email && level === "charity" && (
        <div>
          <TitleSec name="常見問題" color="#90aacb" />
          <div style={{ marginBottom: "50px" }}>
            <Container>
              <div style={{ width: "80%", marginLeft: "10%" }}>
                <p
      ...
      {user.email === email && level === "admin" && (
        <div>
          <TitleSec name="常見問題" color="#7BBFBA" />
          <div style={{ marginBottom: "50px" }}>
            <Container>
              <div style={{ width: "80%", marginLeft: "10%" }}>
                <p
